...
def show_volume(qtile):
    ...
    current_volume = subprocess.getoutput(r"amixer get Master | grep -oP '\[\d+%\]' | head -n 1 | sed 's/\[\|\]//g'")
    
    if current_volume == "0%":

        controls = [
                PopupImage(
                filename="/home/vicky/.config/qtile/icons/mute.svg",
                row=0, col=0,
                width=0.9,
                height=0.9
            ),
        ...
        controls = [
                PopupImage(
                filename="/home/vicky/.config/qtile/icons/volume.svg",
                row=0, 
                col=0,
                width=0.9,
                height=0.9
...
#GROUP SHORTCUT
    ...
    Key([mod],"KP_Add",lazy.spawn("amixer -q sset Master 5%+"),lazy.function(show_volume)),
    Key([mod],"KP_Subtract",lazy.spawn("amixer -q sset Master 5%-"),lazy.function(show_volume)),
    Key([mod],"p", lazy.function(show_volume)),
    ]
...
screens = [Screen(
    wallpaper = "/home/vicky/.config/qtile/icons/blue cyber.jpg",
    wallpaper_mode='fill' ,
